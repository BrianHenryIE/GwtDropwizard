package ie.brianhenry.gwtdropwizard.client;
 ...
 */
public class GwtDropwizardClient implements EntryPoint {
	/**
	...
	public void onModuleLoad() {
		...
		RootPanel.get("gwt").add(nameField);
		RootPanel.get("gwt").add(sendButton);
		RootPanel.get("gwt").add(errorLabel);
